...
public interface UserMapper {
    ...
    @Insert("insert into user2(id, name, age, email, address) values(#{id}, #{name}, #{age}, #{email}, #{address})")
    boolean save(@Param("id") Long id, @Param("name") String name, @Param("age") int age, @Param("email") String email, @Param("address") String address);
